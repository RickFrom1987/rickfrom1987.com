...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _Membean = __webpack_require__(164);
  
  var _Membean2 = _interopRequireDefault(_Membean);
  
  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
  
  exports.default = _Membean2.default;
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _Membean = __webpack_require__(278);
  
  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
  
  var MembeanPage = function (_React$Component) {
    (0, _inherits3.default)(MembeanPage, _React$Component);
  
    function MembeanPage() {
      (0, _classCallCheck3.default)(this, MembeanPage);
      return (0, _possibleConstructorReturn3.default)(this, (MembeanPage.__proto__ || (0, _getPrototypeOf2.default)(MembeanPage)).apply(this, arguments));
    }
  
    (0, _createClass3.default)(MembeanPage, [{
      key: 'componentDidMount',
      value: function componentDidMount() {
        document.title = _Membean.title;
      }
    }, {
      key: 'render',
      value: function render() {
        return _react2.default.createElement(
          ...
          { title: _Membean.title, url: _Membean.url },
          _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: _Membean.html } })
        );
      }
    }]);
    return MembeanPage;
...
/***/ (function(module, exports) {
  ...
  module.exports = {"title":"Membean","subtitle":2018,"url":"https://membean.com","html":"<p>I love working with Oregon based tech-ed company <a href=\"//membean.com\">Membean</a>. The team at Membean want improve the education system, while improving student's memory and cognitive ability as a whole.</p>\n<p><b>React. React. React.</b></p>\n<p>\n<p>Membean is in the process of moving from a old school Rails app to a hybrid Rails/React app. The goal is to build out the next generation/iteration of Membean app in React. We used enzyme for unit testing, which was a pleasure to work with. Redux for state mangement win!</p>\n</p>\n<p><b>Technical Challenges</b></p>\n<p>\n<ul>\n<li>\n<p>The spikyness level of the traffic. We provide educational software used mostly during school hours, which means lots of students logging in/out and using our service at the same time. This creates an interesting problem of having heavy usage during certain hours depending on where the school is the world.</p>\n</li>\n<li>\n<p>Deploys need to be carefully planned, as there is no need to deploy during heavy usage, or during a busy time of the school year. Very tight time windows and little room for error.</p>\n</li>\n<li>\n<p>Optimizing assets and filesize so that students are able to download assets and our js package once. Networks at school at the time of this writing are all over the map. Some with fantastic network speeds, some that are simply unusable.</p>\n</li>\n</ul>\n</p>\n<p><b>People</b></p>\n<p>\n<p>What can I say. In the tech industry often you find some amount of pretentiousness or &quot;bottom line&quot; guys and gals. Not here. I have never met founders as inpiring. Absolutely amazing team, so kind, friendly and genuine. I have learned so much. Technically and the powerglobal reach andf importance of learning. Work or help them out with anything for the rest of my life if possible.</p>\n</p>"};

/***/ })

});
//# sourceMappingURL=8.js.map?e1c8e3e0665ee8671f92